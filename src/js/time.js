...
export const time = () => {
    ...
    const [marriageDiv, temumantenDiv, receptionDiv] = timeContainer.querySelectorAll('div div');
    ...
    temumantenDiv.innerHTML = createTimeListItem('Temu Manten', data.time.temumanten);
